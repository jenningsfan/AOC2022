...
INPUT_FILE = Path(SCRIPT_DIR, "inputs/17.txt")
...
class Tower():
    ...
    def calculate_height(self, shape_drops: int) -> tuple[int, int]:
        ...
        print(f"dropped {shape_drops} rd {remaining_drops} rq {repeats_req}")
        remaining_drops %= self._repeat[1]      # remaining individual drops
        
        print(f"rd {remaining_drops} rq {repeats_req}")
...
def main():
    ...
    new_height, remaining_drops = tower.calculate_height(2022)
